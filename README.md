...
│   └── README.md                 # Model-specific instructions
├── LSTM_Enc_Dec.ipynb            # LSTM model notebook
├── NMT_using_Transformer.ipynb   # Transformer model notebook
...
2. *Install dependencies for each model:*
   ...
   - For ConvSeq2Seq and LSTM models, see their respective Readme.md or install:
     bash
